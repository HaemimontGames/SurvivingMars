...
PlaceObj('ActionFXSound', {
	...
	'EndAction1', "RegolithExtractorDigging",
...
PlaceObj('ActionFXSound', {
	...
	'EndMoment1', "end",
	'handle', 1845930611,
	'Sound', "Building MartianUni Loop",
	'FadeIn', 500,
	'FadeOut', 500,
	'AttachToObj', true,
})
...
PlaceObj('ActionFXSound', {
	...
	'EndMoment1', "end",
	'handle', 431559711,
	'Sound', "Building OpenAirGym Loop",
	'FadeIn', 2000,
	'FadeOut', 2000,
	'AttachToObj', true,
})
...
PlaceObj('ActionFXSound', {
	...
	'EndMoment1', "end",
	'handle', 563803895,
	'Sound', "Building Playground Loop",
	'FadeIn', 1000,
	'FadeOut', 1000,
	'AttachToObj', true,
})
