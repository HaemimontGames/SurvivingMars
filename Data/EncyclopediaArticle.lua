...
PlaceObj('EncyclopediaArticle', {
	...
	'title_text', T{4142, --[[EncyclopediaArticle Dust Devils title_text]] "Dust Devils"},
	'image', "UI/Encyclopedia/DustDevil.tga",
	'text', T{5379, --[[EncyclopediaArticle Dust Devils text]] "Dust Devils form when hot gases near the ground rise quickly through a small pocket of cooler, low-pressure gases above it. They become a vortex of the dust and particles caught by these gases and form a visible pillar that moves and twists.\n\nMartian Dust Devils can be up to fifty times as wide and ten times as high as dust devils on Earth, and they pose a threat to any technology within their vicinity as they tend to cover everything around them with dust."},
})

PlaceObj('EncyclopediaArticle', {
	'name', "CATEGORY: Resources",
	'category_id', "Resources",
	'title_text', T{692, --[[EncyclopediaArticle CATEGORY: Resources title_text]] "Resources"},
	'title_text_upper', T{4270, --[[EncyclopediaArticle CATEGORY: Resources title_text_upper]] "RESOURCES"},
	'text', T{5380, --[[EncyclopediaArticle CATEGORY: Resources text]] "Resources are either gathered directly from Mars, or later manufactured in resource production buildings – most commonly from other resources.\n\nThey keep the Colony operational by being used for life-support, construction and building upkeep. \n\nThere are two types of resources; <em>grid</em>  and <em>non-grid</em>.\n\nGrid resources use <em>Pipes</em> and <em>Cables</em> for distribution, while non-grid resources have to be moved around with <em>Drones</em> or <em>RC Rovers</em>."},
})
...
PlaceObj('EncyclopediaArticle', {
	...
	'title_text', T{3517, --[[EncyclopediaArticle Electronics title_text]] "Electronics"},
	'image', "UI/Encyclopedia/Electronics.tga",
	'text', T{5383, --[[EncyclopediaArticle Electronics text]] "Electronics <image UI/Icons/Sections/Electronics_1.tga> are manufactured in <em>Electronics Factories</em> from <em>Rare Metals</em> and are mainly used for vehicle operating buildings, like <em>Drone Hubs</em> and <em>Shuttle Hubs</em>. \n\n<center><image UI/Common/rollover_line.tga 2000> <left>\n\nTechnology and electronics go hand in hand on Mars the same way as they have, and will continue to for centuries to come, on Earth."},
})
...
PlaceObj('EncyclopediaArticle', {
	...
	'category_id', "Resources",
	'title_id', "Fuel",
	'title_text', T{4765, --[[EncyclopediaArticle Fuel title_text]] "Fuel"},
	'image', "UI/Encyclopedia/Fuel.tga",
	'text', T{5385, --[[EncyclopediaArticle Fuel text]] "Fuel <image UI/Icons/Sections/Fuel_1.tga> is synthesized in <em>Fuel Refineries</em> and is used to for refueling <em>Rockets</em> bound for Earth, for keeping <em>Shuttle Hubs</em> operational and for polymer production.\n\n<center><image UI/Common/rollover_line.tga 2000> <left>\n\nUsing the CO2 from the Martian atmosphere and hydrogen (from water) we can produce fuel to fly our rockets back to Earth. The process uses a series of relatively simple chemical reactions to produce methane and oxygen which are used as propellant for both our rockets and shuttles."},
})
...
PlaceObj('EncyclopediaArticle', {
	...
	'title_text', T{4139, --[[EncyclopediaArticle Rare Metals title_text]] "Rare Metals"},
	'image', "UI/Encyclopedia/Rare_Metals.tga",
	'text', T{5391, --[[EncyclopediaArticle Rare Metals text]] "Rare metals  <image UI/Icons/Sections/PreciousMetals_1.tga>  are found only in underground deposit sites and need <em>Rare Metal Extractors</em> to mine them. They are mostly used for manufacturing electronics and for exporting back to Earth.\n\n<center><image UI/Common/rollover_line.tga 2000> <left>\n\nAfter millennia of acting as a status symbol, in modern times rare metals are widely used in electronics and for medical procedures. Still, although one of the vital elements of the Information, and subsequently the Space Ages, precious metals still retain their monetary role."},
})
...
PlaceObj('EncyclopediaArticle', {
	...
	'title_text', T{1684, --[[EncyclopediaArticle Explorer title_text]] "RC Explorer"},
	'image', "UI/Encyclopedia/ExplorerRover.tga",
	'text', T{5400, --[[EncyclopediaArticle Explorer text]] "RC Explorers carry with them advanced examination and research apparatus, making them the perfect vehicle to analyze any anomalous reading from anywhere in the region. As all Rovers, they are remotely controlled and can reach far-out locations if the terrain permits it.  \n\nExplorers are battery powered and can recharge their batteries at any point along a power cable.\n\n<center><image UI/Common/rollover_line.tga 2000> <left>\n\nThe apex of human transport technology, Rovers have extended battery lives and are incredibly durable, making them resistant to most of the Martian calamities such as cold or dust. They may traverse the Colony site and reach distant spots, limited only by the topography, to tackle whatever they have been tasked with."},
})
...
PlaceObj('EncyclopediaArticle', {
	...
	'category_id', "GameMechanics",
	'title_id', "Wonders",
	'title_text', T{88, --[[EncyclopediaArticle Wonders title_text]] "Wonders"},
	'image', "UI/Encyclopedia/Hints.tga",
	'text', T{5424, --[[EncyclopediaArticle Wonders text]] "Wonders are exceptionally advanced and expensive structures that provide major benefits for the entire Colony. They are unlocked at the far ends of the <em>Research Tree</em>.\n\nEach wonder is unique and can be constructed only once."},
})
