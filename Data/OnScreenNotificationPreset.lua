...
PlaceObj('OnScreenNotificationPreset', {
	...
	image = "UI/Icons/Notifications/New/mystery_log_2.tga",
	priority = "Important",
...
PlaceObj('OnScreenNotificationPreset', {
	...
	image = "UI/Icons/Notifications/New/research_2.tga",
	priority = "Important",
...
PlaceObj('OnScreenNotificationPreset', {
	...
	image = "UI/Icons/Notifications/New/scan_2.tga",
	priority = "Important",
...
PlaceObj('OnScreenNotificationPreset', {
	...
	group = "Default",
	id = "CropsFailed",
	image = "UI/Icons/Notifications/New/food.tga",
...
PlaceObj('OnScreenNotificationPreset', {
	...
	id = "DestroyedDrones",
	image = "UI/Icons/Notifications/New/drone.tga",
	text = T{10953, --[[OnScreenNotificationPreset DestroyedDrones text]] "Destroyed Drones: <count><image UI/Icons/res_drone_red.tga 1300>"},
	title = T{10954, --[[OnScreenNotificationPreset DestroyedDrones title]] "Destroyed Drones"},
})
