...
PlaceObj('PopupNotificationPreset', {
	...
	image = "UI/Messages/deposits.tga",
	text = T{534811629364, --[[PopupNotificationPreset SuggestedResupplyMission text]] "Back on Earth, a dutiful team is standing by for our call. In mere hours they can prepare a new rocket and fill it with whatever resources we request, within the limits of the funding provided by our sponsor. Don’t hesitate to make the call and secure valuable resources which we still can’t produce ourselves, or we are deprived of on the surface of the Red Planet.\n\n<hint><if(gamepad)>You can open the Resupply screen from the <LT> menu and order a new rocket with resources, buildings and vehicles from Earth.</if><if(kbmouse)>You can open the Resupply screen from the <em>HUD button</em> and order a new rocket with resources, buildings and vehicles from Earth.</if>\n\n<hint>Resupply missions can be used as long as you have Funding and available Rockets on Earth."},
	title = T{430535344144, --[[PopupNotificationPreset SuggestedResupplyMission title]] "Resupply Rockets"},
	voiced_text = T{983388575800, --[[voice:narrator]] "Mission Control suggests that we order a rocket with valuable supplies from Earth. We still need all the help we can get to survive the harsh environment of the Red Planet."},
})
