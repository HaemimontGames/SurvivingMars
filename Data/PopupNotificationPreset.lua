...
PlaceObj('PopupNotificationPreset', {
	...
	text = T{10477, --[[PopupNotificationPreset Disaster_DustStorm text]] "A dust storm is set to hit the colony soon. \n\nDust storms cause damage to Pipes and Cables and also will place a serious strain on all buildings – pushing them towards needing maintenance sooner than usual. \n\nDuring Dust Storms, Solar Panels outside Domes are automatically closed. MOXIEs and Water Vaporators cannot function. This can be especially perilous if the colony has little or no reserves of Power, Water and Oxygen.\n\nLike all disasters, Dust Storms cannot be avoided but may be better dealt with after proper preparations. Stocking up on Power, Water and Oxygen in batteries and tanks is a good start. Disabling non-vital buildings that consume these resources prior and during a Dust Storm will help get by on the available reserves. "},
...
PlaceObj('PopupNotificationPreset', {
	...
	text = T{10478, --[[PopupNotificationPreset Disaster_MeteorStorm text]] "The region is about to experience a Meteor Storm. \n\nWhile it may occur at a safe distance from your buildings and vehicles, it may also occur above them and then it has the potential to cause substantial damage. \n\nBuildings directly hit by meteors will be in need of repairs in order to function again while Pipes and Cables will get destroyed. \n\nRovers hit by meteors will also need repairs while Drones may become irreversibly damaged. \n\nMeteor Storms cannot be avoided but some good practices may minimize their damage potential, such as not clustering vital buildings next to each other, Pipe and Cable redundancy and researching the tech for MDS Lasers from the Physics field."},
...
PlaceObj('PopupNotificationPreset', {
	...
	text = T{10479, --[[PopupNotificationPreset Disaster_ColdWave text]] "A Cold Wave is imminent. \n\nDuring Cold Waves the surface temperatures on Mars fall substantially beneath the already extreme lows that are normally experienced.\n\nCold Waves put an extra strain on the electrical grid and everything will consume more electricity – including vehicles. Vehicle batteries will drain faster during Cold Waves.\n\nWhile most of our machinery is designed and able to function in such low temperatures, if a building outside of a Dome is left un-operational for more than a Sol during a Cold Wave, it will freeze and may not be repaired until after the Cold Wave has lifted.\n\nStored Water in Water Tanks will freeze and may not be used during Cold Waves. One way to negate this is to place Subsurface Heaters (researched from the Physics field) near vulnerable to Cold Wave buildings.  "},
...
PlaceObj('PopupNotificationPreset', {
	...
	group = "Default",
	id = "Evaluation_Export_Beginning",
