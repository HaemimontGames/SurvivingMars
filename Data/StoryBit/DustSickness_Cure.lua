...
PlaceObj('StoryBit', {
	...
	Text = T{683350336026, --[[StoryBit DustSickness_Cure Text]] "One of our Scientists has come up with paper that proposes two possible solutions to the Dust Sickness. The research may take a long time to complete but there are possible shortcuts.\n\n<goal>Research the “Dust Sickness Cure” tech to cure all Colonists from the affliction"},
