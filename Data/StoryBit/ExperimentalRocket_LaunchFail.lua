...
PlaceObj('StoryBit', {
	...
	VoicedText = T{588921706704, --[[voice:narrator]] "The rocket launch was catastrophic failure! A seal in the booster ruptured allowing a jet of pressurized gas into the fuel chamber, ultimately causing a massive explosion! "},
	group = "Rocket",
	...
	PlaceObj('StoryBitReply', {
		'Text', T{916159646901, --[[StoryBit ExperimentalRocket_LaunchFail Text]] "At least no human lives has been lost..."},
		'Prerequisite', PlaceObj('IsRocketType', {
			'Type', "Passenger",
			'Negate', true,
		}),
