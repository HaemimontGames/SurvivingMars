...
PlaceObj('StoryBit', {
	...
	PlaceObj('StoryBitReply', {
		'Text', T(774357050689, --[[StoryBit GeoLife Text]] "Follow the protocol and sterilize the Geoscape Dome, perhaps there is an unseen danger there."),
		'OutcomeText', "custom",
		'CustomOutcomeText', T(816903284390, --[[StoryBit GeoLife CustomOutcomeText]] "Colonists in the Geoscape Dome lose <comfort_loss> Comfort"),
	}),
	...
	PlaceObj('StoryBitReply', {
		'Text', T(432642667402, --[[StoryBit GeoLife Text]] "Observe the life cycle of the organism in the Geoscape Dome ecosystem - this is a unique opportunity to learn!"),
	}),
	PlaceObj('StoryBitOutcome', {
		'Prerequisites', {},
		'Weight', 75,
