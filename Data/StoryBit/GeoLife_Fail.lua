...
PlaceObj('StoryBit', {
	...
	Text = T{623050970123, --[[StoryBit GeoLife_Fail Text]] "We are forced to have to evacuate all Colonists until the Dome has been sterilized.\n\n<effect>GeoDome will be closed off for <sols(disable_duration)> Sols."},
