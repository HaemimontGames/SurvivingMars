...
PlaceObj('StoryBit', {
	...
	TextsDone = true,
	VoicedText = T(822302863249, --[[voice:narrator]] "The first few hours after DreamWeb went public were astonishing! The new tech fad has exceeded everyone's expectations and is a smashing hit."),
	group = "Sponsor",
