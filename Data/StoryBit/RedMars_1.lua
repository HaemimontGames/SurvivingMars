...
PlaceObj('StoryBit', {
	...
	PlaceObj('StoryBitOutcome', {
		'Prerequisites', {},
		'VoicedText', T{403120348851, --[[voice:narrator]] "We approached the mysterious facility with apprehension, but nothing bad happened. It appears that the location had been abandoned decades ago."},
