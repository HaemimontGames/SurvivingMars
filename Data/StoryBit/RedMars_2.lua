...
PlaceObj('StoryBit', {
	...
	PlaceObj('StoryBitOutcome', {
		...
		'Text', T{646429066953, --[[StoryBit RedMars_2 Text]] "<task>Return to the coordinates of the secret facility. Upon completion, you will receive <funding(reward_funding)> Funding."},
		'Enables', {
			"RedMars_4",
		},
		'Effects', {
