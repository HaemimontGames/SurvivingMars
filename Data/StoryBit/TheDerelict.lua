...
PlaceObj('StoryBit', {
	...
	PlaceObj('StoryBitOutcome', {
		'Prerequisites', {},
		'Weight', 50,
		'VoicedText', T(976690332107, --[[voice:narrator]] "Cutting carefully through the twisted hull, the expedition managed to gain safe access to the dark cargo hold of the rocket."),
