...
PlaceObj('StoryBit', {
	...
	Prerequisites = {},
	ScriptDone = true,
	Text = T{424267233026, --[[StoryBit TheFugitive Text]] "Turns out one of our Founders to be, despite having passed a rigorous vetting program, is now identified as a wanted fugitive.\n\nInterpol hasn't secured the proper permits and currently holds no jurisdiction to force us turn them in but offers a significant financial incentive if we do so on our own accord.\n\nIf we accept, we will have no time to train a replacement and will have to launch with one Founder less."},
	...
	PlaceObj('StoryBitReply', {
		'Text', T{933123454442, --[[StoryBit TheFugitive Text]] "We don't want a criminal as one of our Founders. Bring them in with the next flight to Earth."},
	}),
