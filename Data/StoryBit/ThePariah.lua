...
PlaceObj('StoryBit', {
	...
	PlaceObj('StoryBitOutcome', {
		'Prerequisites', {},
		'VoicedText', T{739899532483, --[[voice:narrator]] "The empath is banished from the colony and would soon leave for Earth. It’s for the good of all, but the other Empaths don’t see it that way."},
		'Text', T{272960218447, --[[StoryBit ThePariah Text]] "This case was a precedent. If it repeats in the future, Empaths will be treated the same, banished and ostracized from their homes. Some of them feel as if they are ticking bombs, threatening the sanity of their fellows and fear that many Colonists would view them as a threat from now on.\n\n<effect><DisplayName> has left the Colony. All Empaths lose <empathy_morale_penalty>Morale for <empathy_morale_down_duration> Sols."},
		'Effects', {
