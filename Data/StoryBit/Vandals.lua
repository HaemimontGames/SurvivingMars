...
PlaceObj('StoryBit', {
	...
	ScriptDone = true,
	Text = T{796006225278, --[[StoryBit Vandals Text]] "Albeit the biggest such incident lately, it is not the first. We suspect a gang of renegades led by a self declared Street King named <DiplayName> to be responsible.\n\nSo far they have always smartly evaded our attempts to catch them in the act."},
	...
	PlaceObj('StoryBitOutcome', {
		...
		'Effects', {
			PlaceObj('ForEachExecuteEffects', {
				...
				'Filters', {},
				'Effects', {
					PlaceObj('SetBuildingBreakdownState', nil),
				},
			}),
		},
	}),
