...
PlaceObj('StoryBit', {
	...
	TextsDone = true,
	VoicedText = T(840891259939, --[[voice:narrator]] "The vandals have fallen for your trap. They just couldn't resist vandalizing the \"unwatched\" rover just idling there."),
	group = "Renegades",
	id = "Vandals_FollowUp_1",
	PlaceObj('StoryBitReply', {
		'Text', T(540665456146, --[[StoryBit Vandals_FollowUp_1 Text]] "A two hour scolding session seems in order. Then a wristband to always monitor the kid."),
	}),
	PlaceObj('StoryBitReply', {
