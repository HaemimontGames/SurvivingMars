...
PlaceObj('StoryBit', {
	...
	PlaceObj('StoryBitOutcome', {
		...
		'Text', T{890881331652, --[[StoryBit ViolentDelights Text]] "(minor)<effect><DisplayName> has died. <injured_rescuers> Colonists lost <rescue_damage> Health."},
		'Effects', {
			PlaceObj('ForEachExecuteEffects', {
				'Label', "Colonist",
				'Filters', {},
