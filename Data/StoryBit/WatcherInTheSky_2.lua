...
PlaceObj('StoryBit', {
	...
	TextsDone = true,
	VoicedText = T(292301974891, --[[voice:narrator]] "Our explorer discovered an old device hidden in a cave. It is of terrestrial origin. Perhaps a relic of the old Space Race?"),
	group = "Colonists",
