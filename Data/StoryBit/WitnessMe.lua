...
PlaceObj('StoryBit', {
	...
	PlaceObj('StoryBitOutcome', {
		...
		'Text', T{527619615617, --[[StoryBit WitnessMe Text]] "The surfaces bends in and surrenders under the force of the impact, the air inside leaving with a sinister hissing. Luckily, the colonist inside the rover suffered only a concussion, and is now feeling better, but ashamed.\n\n<effect>A Dome has received <crack_amount> fractures."},
		'Effects', {
			PlaceObj('ForEachExecuteEffects', {
				'Label', "Dome",
				'Filters', {},
