...
UnlockCrop("Giant Rice", self.id)
		...
		PlaceObj('Tech', {
			...
			'display_name', T{8858, "Creative Biorobotics"},
			'icon', "UI/Icons/Research/creative_biorobotics.tga",
			'description', T{8859, "New Building: <em>Biorobotics Workshop</em> (<buildinginfo('BioroboticsWorkshop')>) - a vocation building that allows colonists to experiment with biorobots (counts towards the workshop milestone). Consumes Machine Parts.\n\n<grey>\"We are fascinated with robots because they are reflections of ourselves.\"\n<right>Ken Goldberg</grey><left>"},
	...
	PlaceObj('TechField', {
		...
		PlaceObj('Tech', {
			'id', "MegaStorage",
			'display_name', T{8860, "Mega Storage"},
			'icon', "UI/Icons/Research/mega_storage.tga",
			'description', T{8861, "New Building: <em>Large Water Tank</em> (<buildinginfo('LargeWaterTank')>) - stores very large amounts of water.\n\n<grey>\"If there's magic on this planet, it is contained in water.\"\n<right>Loren Eiseley</grey><left>"},
			'position', range(6, 12),
			'field', "Engineering",
		}, {
			PlaceObj('TechEffect_EditProps', nil),
	...
	PlaceObj('TechField', {
		...
		PlaceObj('Tech', {
			'id', "AutomatedStorage",
			'display_name', T{8862, "Automated Storage"},
			'icon', "UI/Icons/Research/automated_storage.tga",
			'description', T{8863, "New Buildings: <em>Storages</em> (<buildinginfo('MechanizedDepotMetals')>) - a set of storages that can store large amount of resources but have to be constructed and require power.\n\n<grey>\"The more storage you have, the more stuff you accumulate.\"\n<right>Alexis Stewart</grey><left>"},
			'position', range(6, 10),
			'field', "Robotics",
		}, {
			PlaceObj('TechEffect_EditProps', nil),
	...
	PlaceObj('TechField', {
		...
		PlaceObj('Tech', {
			...
			'display_name', T{8864, "Creative Realities"},
			'icon', "UI/Icons/Research/creative_realities.tga",
			'description', T{8865, "New Building: <em>VR Workshop</em> (<buildinginfo('VRWorkshop')>) - a vocation building that allows colonists to experiment with virtual reality (counts towards the workshop milestone). Consumes Electronics.\n\n<grey>\"How do you know it's Sci-Fi? VR is commercially viable.\"\n<right>Shams Jorjani</grey><left>"},
	...
	PlaceObj('TechField', {
		...
		PlaceObj('Tech', {
			...
			'display_name', T{8866, "Creative Disposition"},
			'icon', "UI/Icons/Research/creative_disposition.tga",
			'description', T{8867, "New Building: <em>Art Workshop</em> (<buildinginfo('ArtWorkshop')>) - a vocation building that allows colonists to experiment with different forms of art (counts towards the workshop milestone). Consumes Polymers.\n\n<grey>\"We don't make mistakes, just happy little accidents.\"\n<right>Bob Ross</grey><left>"},
			'position', range(12, 19),
			'field', "Social",
		}, {
			PlaceObj('TechEffect_EditProps', nil),
