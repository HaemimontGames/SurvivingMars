...
Building derived [building template](ModItemBuildingTemplate.md.html) class. Handles power consumption for a building. All buildings in the game that consume power inherit or are this class.<br>
## Parent classes
