...
Building derived [building template](ModItemBuildingTemplate.md.html) class. Handles water production for a building. All buildings that produce water for the water grid are either of this class or a derived class.<br>
## Parent classes
