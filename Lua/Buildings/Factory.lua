...
DefineClass.PolymerPlant = {
	...
	properties = {
		{ template = true, category = "Consumption",   name = T{681, "Water"},                   id = "water_consumption",       editor = "number", default = 5000,   scale = const.ResourceScale, read_only = false, modifiable = true, min = 0, },
		{ template = true, category = "Consumption",   name = T{682, "Oxygen"},                     id = "air_consumption",         editor = "number", default = 0,      scale = const.ResourceScale, read_only = true , modifiable = true, min = 0, },
