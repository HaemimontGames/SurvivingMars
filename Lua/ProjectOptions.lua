...
function OnMsg.ClassesGenerate(classdefs) 
	classdefs.OptionsObject.properties = {
		...
		{ name = T(3574, "Bloom"), id = "Bloom", category = "Video", storage = "local", editor = "bool", on_value = "On", off_value = "Off", default = "On" },
		{ name = T(8034, "Eye Adaptation"), id = "EyeAdaptation", category = "Video", storage = "local", editor = "bool", on_value = "On", off_value = "Off", default = "On" },
		{ name = T(3455, "Vignette"), id = "Vignette", category = "Video", storage = "local", editor = "bool", on_value = "On", off_value = "Off", default = "On" },
		{ name = T(10075, "SSAO"), id = "SSAO", category = "Video", storage = "local", editor = "bool", on_value = "On", off_value = "Off", default = "On" },
		...
		{ name = T(3589, "Controller"), id = "Gamepad", category = "Controls", SortKey = 100000, storage = "account", editor = "bool", default = Platform.console and true or false, filter = FilterNonConsole,},
		...
		{ name = T(11861, "Control Scheme"), id = "ControlScheme", category = "Controls", storage = "account", editor = "dropdown", default = Platform.console and "Controller" or "Hybrid", filter = FilterConsole,},
		...
		{ name = T(11518, "Show Fireworks"), id = "ShowFireworks", category = "Gameplay", storage = "local", editor = "bool", on_value = "On", off_value = "Off", default = "On" },
