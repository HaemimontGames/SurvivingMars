			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateTemplate', {
						...
						'RolloverHint', T{4003, --[[XTemplate HUD RolloverHint]] "<em><ShortcutName('actionOpenBuildMenu')></em> Toggle Build Menu"},
						'Id', "idBuild",
...
HUD.idBuildOnPress()
					...
					PlaceObj('XTemplateTemplate', {
						...
						'RolloverHint', T{4013, --[[XTemplate HUD RolloverHint]] "<em><ShortcutName('actionMapOverview')></em> Toggle Overview Mode"},
						'Id', "idOverview",
...
HUD.idOverviewOnPress()
					...
					PlaceObj('XTemplateTemplate', {
						...
						'RolloverHint', T{4007, --[[XTemplate HUD RolloverHint]] "<em><ShortcutName('actionResupplyScreen')></em> Open Resupply Screen"},
						'Id', "idResupply",
...
if g_Tutorial and not g_Tutorial.EnableResupply then
	...
	self:SetRolloverDisabledText(T{4009, "<red>All resupply missions are suspended.</red>"})
					...
					PlaceObj('XTemplateTemplate', {
						...
						'RolloverHint', T{4005, --[[XTemplate HUD RolloverHint]] "<em><ShortcutName('actionResearchScreen')></em> Open Research Screen"},
						'Id', "idResearch",
...
HUD.UpdateDesatModifier(self)
					...
					PlaceObj('XTemplateTemplate', {
						...
						'RolloverHint', T{8981, --[[XTemplate HUD RolloverHint]] "<em><ShortcutName('actionColonyControlCenter')></em> Тoggle Command Center"},
...
HUD.idColonyControlCenterOnPress()
					...
					PlaceObj('XTemplateTemplate', {
						...
						'RolloverHint', T{4011, --[[XTemplate HUD RolloverHint]] "<em><ShortcutName('actionMilestonesScreen')></em> Open Milestones Screen"},
						'Id', "idMilestones",
...
HUD.UpdateDesatModifier(self)
					...
					PlaceObj('XTemplateTemplate', {
						...
						'RolloverHint', T{11029, --[[XTemplate HUD RolloverHint]] "<em><ShortcutName('actionMissionProfile')></em> Open Mission Profile"},
						'Id', "idGoals",
			...
			PlaceObj('XTemplateWindow', {
				...
				PlaceObj('XTemplateWindow', {
					...
					PlaceObj('XTemplateTemplate', {
						...
						'RolloverHint', T{7386, --[[XTemplate HUD RolloverHint]] "<em><ShortcutName('actionRadio')></em> Open Radio"},
						'Id', "idRadio",
