...
GenerateCurrentRandomMap()
				...
				PlaceObj('XTemplateMode', {
					...
					PlaceObj('XTemplateWindow', {
						...
						'TextColor', RGBA(118, 163, 222, 255),
						'Translate', true,
						'Text', T{345420497005, --[[XTemplate PGChallengePayload Text]] "<PrefabsTitle>"},
						'TextHAlign', "right",
					}),
					PlaceObj('XTemplateAction', {
						'ActionId', "back",
			...
			PlaceObj('XTemplateWindow', {
				...
				'Translate', true,
				'Text', T{954934126187, --[[XTemplate PGChallengePayload Text]] "Cargo Capacity <white><Capacity> kg</white>\nFunding <white><funding(Funding)></white>"},
				'TextHAlign', "right",
			}),
			PlaceObj('XTemplateWindow', {
				...
				'RolloverTextColor', RGBA(118, 163, 222, 255),
				'Translate', true,
				'Text', T{253829683975, --[[XTemplate PGChallengePayload Text]] "Cargo Capacity <white><Capacity> kg</white>\nFunding <white><funding(Funding)></white>\nAvailable Rockets <white><AvailableRockets>/<TotalRockets></white>"},
				'TextHAlign', "right",
			}),
			PlaceObj('XTemplateWindow', {
			...
			PlaceObj('XTemplateWindow', {
				'__condition', function (parent, context) return GameState.gameplay and UICity and UICity.launch_mode == "pod" end,
				'__class', "XText",
				'Dock', "top",
				'HAlign', "right",
				'TextFont', "PGLandingPosDetails",
				...
				'RolloverTextColor', RGBA(118, 163, 222, 255),
				'Translate', true,
				'Text', T{171743185132, --[[XTemplate PGChallengePayload Text]] "Cargo Capacity <white><Capacity> kg</white>\nFunding <white><funding(Funding)></white>"},
				'TextHAlign', "right",
			}),
			PlaceObj('XTemplateWindow', {
				'__class', "XFrame",
