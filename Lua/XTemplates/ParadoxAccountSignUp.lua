					...
					PlaceObj('XTemplateWindow', {
						...
						PlaceObj('XTemplateWindow', {
							...
							PlaceObj('XTemplateWindow', {
								...
								'Dock', "left",
								'VAlign', "center",
								'TextFont', "ModsUISignUpFieldLabel",
								'ShadowSize', 0,
								'Translate', true,
...
OpenParadoxTermsURL()
						...
						'RolloverBackground', RGBA(0, 0, 0, 0),
						'PressedBackground', RGBA(0, 0, 0, 0),
						'TextFont', "ModsUILogInText",
						'TextColor', RGBA(66, 151, 222, 255),
						'RolloverTextColor', RGBA(66, 151, 222, 255),
						'Translate', true,
...
self.idCheck:SetCheck(value)
					...
					PlaceObj('XTemplateWindow', {
						...
						'Columns', 2,
						'TextFont', "ModsUILogInButtons",
						'TextColor', RGBA(255, 255, 255, 255),
						'RolloverTextColor', RGBA(255, 255, 255, 255),
						'DisabledTextColor', RGBA(255, 255, 255, 255),
						'DisabledRolloverTextColor', RGBA(255, 255, 255, 255),
						'Translate', true,
