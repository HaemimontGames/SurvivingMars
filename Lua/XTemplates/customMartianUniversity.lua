...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateTemplate', {
		...
		'RolloverHint', T{703125928773, --[[XTemplate customMartianUniversity RolloverHint]] "<left_click> Select Specialization"},
		'RolloverHintGamepad', T{896744390747, --[[XTemplate customMartianUniversity RolloverHintGamepad]] "<ButtonA> Select Specialization"},
