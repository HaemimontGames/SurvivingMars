...
PlaceObj('XTemplate', {
	...
	PlaceObj('XTemplateGroup', {
		'__condition', function (parent, context) return IsKindOf(context, "UniversalStorageDepot") and not context:IsKindOf("SupplyRocket") and not IsKindOf(context, "SpaceElevator") end,
	}, {
